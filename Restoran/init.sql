...
--
-- Host: localhost    Database: php_proje
-- ------------------------------------------------------
...
INSERT INTO order_items VALUES (3,4,2,2,100000.00,1),(4,4,3,1,123.00,1);
...
INSERT INTO orders VALUES (4,1,'2024-09-20 23:26:19',100061.50,'Completed','Hello Pls Help me',NULL),(5,1,'2024-09-20 23:26:19',100.00,'Pending','hi',NULL),(6,1,'2024-09-20 23:26:19',100.00,'Pending','h',NULL);
...
INSERT INTO users VALUES (1,NULL,'user','Batuhanas','Aluns','batuhanal','$argon2id$v=19$m=65536,t=4,p=1$OW8ybE0ub2hnU0Nyai5OTw$R5VACpOOmOVabQ3jOWF5TqkCB/oIxIMWWTEuFSH9+cs',999499791.50,'2024-09-10 15:07:05','2024-09-10 18:07:05',0,'./uploaded_files/CaptureA.PNG',0),(3,NULL,'user','batuhan','altun','batuhanaltun','$argon2id$v=19$m=65536,t=4,p=1$dy42dUxIZHBJRWl0VExjcA$F26Jq3Huh8Pgyd1Ft3NSL+NiV1/Cq6fcWadP06V0n3A',5000.00,'2024-09-10 15:26:14',NULL,0,NULL,1),(4,4,'company','company','company','companyname','$argon2id$v=19$m=65536,t=4,p=1$Z1d6Q292Z1ZFRzVlSXNmaQ$/7u7ao3o8xWuc1x+aYOMdlo1XhOLA934o/7/RhBMaAU',5000.00,'2024-09-10 15:30:22','2024-09-21 14:53:02',0,NULL,0),(9,9,'company','hello','hello','hewloafpo','$argon2id$v=19$m=65536,t=4,p=1$Q2JKUm1FM2VBYjZkaGdydg$9smjozPJTPha0+W3q9RmX6mEGN0ysSwH4rdiTQ8C1GQ',5000.00,'2024-09-10 16:08:20',NULL,0,NULL,0),(10,10,'company','HelloCOmp','comp','welcomecomp','$argon2id$v=19$m=65536,t=4,p=1$TndkY1UyMVpRYndTTnJjaw$R6C5icsGFtN5lNxxTpCeXfCDbjeUoJIGeIe2iebdl1U',5000.00,'2024-09-10 16:31:15',NULL,0,NULL,0),(11,11,'company','company','cadfa','asdasd','$argon2id$v=19$m=65536,t=4,p=1$cnB1d3ZrZS5xcnhNcXhMUg$ket1G3sBmAMsSHXHNmR6HfMUwcvIJzlAX3snDFU7tk4',5000.00,'2024-09-10 16:31:40',NULL,0,NULL,0),(13,13,'company','123123','1231231','321231','$argon2id$v=19$m=65536,t=4,p=1$cUtQbHdidTlRcFdBeS80Tw$fGMporqJMrIvWnbYxAxzfzyQEk8OSFckWyWetHRev0Y',5000.00,'2024-09-10 16:34:25',NULL,0,NULL,0),(14,14,'company','123','123','123','$argon2id$v=19$m=65536,t=4,p=1$L21yVDZsMGlmOGdEQmxrUw$ILHX8U8EhhwNp5QuB1G7WfwqgJkWwKX16UC0kPlYhZQ',5000.00,'2024-09-10 16:35:12',NULL,0,NULL,0),(15,NULL,'admin','admin','admin','admin','$argon2id$v=19$m=65536,t=4,p=1$OW9aTklIczN4aVNaT0F2MQ$8vENfKwwD+qTnak3Ko3NrAnDnBlK7WiPLRcyNbfUlYk',5000.00,'2024-09-10 22:03:10',NULL,1,NULL,0),(16,16,'company','asdasda','sdasda','asdasdad','$argon2id$v=19$m=65536,t=4,p=1$ZFMzYmtDWExWc1ZjRXAweg$6MhNVuN0Q4SBWEPrrjF8y8KPr4IOy/tbh2kib/Lqe2s',5000.00,'2024-09-21 12:04:33',NULL,0,NULL,0);
...
-- Dump completed on 2024-09-21 21:36:58
